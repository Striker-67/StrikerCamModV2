...
namespace strikercammod.mainmanager
{
    ...
    public class Manager : MonoBehaviourPunCallbacks
    {
        ...
        public void GetPlayers()
        {
            ...
            shouldercam.GetComponentInChildren<Camera>().fieldOfView = FOV;
            fakecam.GetComponentInChildren<Camera>().fieldOfView = FOV;
            ...
            if (rightStickClick)
            {
                shouldercam.transform.Find("Model").gameObject.SetActive(true);
                shouldercam.transform.position = GorillaTagger.Instance.headCollider.transform.position;
                shouldercam.transform.localScale = new Vector3(.1f, .1f, .1f);
                shouldercam.transform.parent = null;
            ...
            FOVTEXT.GetComponent<TextMeshPro>().text = FOV.ToString();
