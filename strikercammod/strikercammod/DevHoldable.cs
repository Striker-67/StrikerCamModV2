...
namespace DevHoldableEngine
{
    public class DevHoldable : HoldableObject
    {
        ...
        public void Update()
        {
            ...
            bool pickLeft = PickUp && leftGrip && Vector3.Distance(GorillaTagger.Instance.leftHandTransform.position, transform.position) < Distance && !InHand && EquipmentInteractor.instance.leftHandHeldEquipment == null && !DidSwap;
            bool swapLeft = InHand && leftGrip && rightGrip && !DidSwap && (Vector3.Distance(GorillaTagger.Instance.leftHandTransform.position, transform.position) < Distance) && !SwappedLeft && EquipmentInteractor.instance.leftHandHeldEquipment == null;
            ...
            bool pickRight = PickUp && rightGrip && Vector3.Distance(GorillaTagger.Instance.rightHandTransform.position, transform.position) < Distance && !InHand && EquipmentInteractor.instance.rightHandHeldEquipment == null && !DidSwap;
            bool swapRight = InHand && leftGrip && rightGrip && !DidSwap && (Vector3.Distance(GorillaTagger.Instance.rightHandTransform.position, transform.position) < Distance) && SwappedLeft && EquipmentInteractor.instance.rightHandHeldEquipment == null;
